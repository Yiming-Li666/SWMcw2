...
public class Maze {
     ...
     * @return true if is touching the obstacles, false if not
     */
     ...
     * @param fromX - x-axis of start point
     * @param toX - x-axis of end point
     * @param fromY - y-axis of start point
     * @param toY - y-axis of end point
     * @return true if has obstacle between two point, false if not
     */
     ...
     */
    public void CreateEasyMaze(Group root) {
        //~~~~~~~~~~~~~~~~~~~~~~~~~ frame ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // top
    ...
    /**
     * Draws the medium maze
     * @param root - root for gameManager
     */
    public void CreateMediumMaze(Group root) {
    	// 24-600 * 49-1225
        //~~~~~~~~~~~~~~~~~~~~~~~~~ frame ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // top
        this.obstacles.add(new BarObstacle(0, 0, "horizontal", 48));
    ...
    /**
     * Draws the difficult maze
     * @param root - root for gameManager
     */
    public void CreateDifficultMaze(Group root) {
        //~~~~~~~~~~~~~~~~~~~~~~~~~ frame ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // top
        this.obstacles.add(new BarObstacle(0, 0, "horizontal", 48));
        // bottom
